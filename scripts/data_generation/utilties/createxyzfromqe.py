"""
This script processes Quantum ESPRESSO output files and converts them into XYZ files, 
including energy and force information for each atom. 
Usage: python <script_name.py> <pwfilename.out> <filename.xyz>
"""
...
def atomic_reference(species):
    atoms = {
                      'H': -16.77118161, # adsorbates referenced to Pt ontop
...
at.arrays['forces'] = np.array(forces,dtype=np.float32)
write_extxyz('temp.xyz',at,comment='')
